    ...
    <div className="text-center py-4 bg-gray-50">
      {isLoadingMore ? (
        <div className="flex items-center justify-center">
          <div className="animate-spin rounded-full h-6 w-6 border-t-2 border-b-2 border-gray-500 mr-2"></div>
            ...
            <>
              ...
              <div ref={historyTableContainerRef} className="overflow-x-auto" style={{ maxHeight: 'calc(100vh - 300px)' }}>
                {initialHistoryLoading ? (
                  <div className="text-center py-10">
                    <div className="inline-block animate-spin rounded-full h-8 w-8 border-t-2 border-b-2 border-gray-500 mb-4"></div>
                    <p className="text-gray-600 text-sm sm:text-base">Loading history data...</p>
                  </div>
                ) : (
                  <>
                    ...
                    {isLoadingMoreHistory && (
                      <div className="sticky bottom-0 left-0 right-0 bg-gray-50 border-t border-gray-200">
                        <div className="flex justify-center items-center py-3">
                          <div className="animate-spin rounded-full h-5 w-5 border-t-2 border-b-2 border-gray-500 mr-2"></div>
                          <span className="text-gray-600 text-xs sm:text-sm">Loading more history...</span>
                        </div>
                      </div>
                    )}
            ...
            >
                ...
                <tbody className="bg-white divide-y divide-gray-200">
                  {filteredAccountData.length > 0 ? (
                    filteredAccountData.map((account, index) => {
                      ...
                      return (
                        <tr key={index} className={`${isSelected ? "bg-gray-50" : ""} hover:bg-gray-50`}>
              ...
              {isFetchingMore && (
                <div className="sticky bottom-0 left-0 right-0 bg-gray-50 border-t border-gray-200">
                  <div className="flex justify-center items-center py-3">
                    <div className="animate-spin rounded-full h-5 w-5 border-t-2 border-b-2 border-gray-500 mr-2"></div>
                    <span className="text-gray-600 text-xs sm:text-sm">Loading more tasks...</span>
                  </div>
                </div>
              )}

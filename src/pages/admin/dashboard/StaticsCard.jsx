...
export default function StatisticsCards({ dashboardType = "default", dateRange = null }) {
  ...
  const { total, completed, pending, not_done, overdue, progress_percent } = stats;
      ...
      <div className="lg:w-1/2">
        <div className="grid grid-cols-3 sm:grid-cols-3 gap-3 sm:gap-4 justify-center">
          ...
          <div className="rounded-lg border border-l-4 border-l-gray-500 shadow-md hover:shadow-lg transition-all bg-white">
            ...
            <div className="p-3 sm:p-4">
              <div className="text-xl sm:text-2xl lg:text-3xl font-bold text-gray-700">{not_done}</div>
              <p className="text-xs text-gray-600">
                {dateRange ? "Not done in period" : "Not Completed tasks"}
              </p>
            </div>
          </div>

...
export default function AdminLayout({ children, darkMode, toggleDarkMode }) {
  ...
  return (
    <div
      className={`flex h-screen overflow-hidden bg-gradient-to-br from-blue-50 to-gray-50`}
    >
      {/* Sidebar for desktop */}
      <aside className="hidden w-64 flex-shrink-0 border-r border-blue-200 bg-white md:flex md:flex-col">
        <div className="flex h-14 items-center border-b border-blue-200 px-4 bg-gradient-to-r from-blue-100 to-gray-100">
          <Link
            to="/dashboard/admin"
                  ...
                  <div>
                    <button
                      ...
                      className={`flex w-full items-center justify-between gap-3 rounded-md px-3 py-2 text-sm font-medium transition-colors ${route.active
                        ? "bg-gradient-to-r from-blue-100 to-gray-100 text-blue-700"
        ...
        <div className="border-t border-blue-200 p-4 bg-gradient-to-r from-blue-50 to-gray-50">
      ...
      <div className="flex flex-1 flex-col overflow-hidden">
        ...
        <main className="flex-1 overflow-y-auto p-4 md:p-6 bg-gradient-to-br from-blue-50 to-gray-50 pb-20 sm:pb-6">
          {children}
          ...
          <div className="fixed md:left-64 left-0 right-0 bottom-0 py-1 px-4 gradient-bg text-white text-center text-sm shadow-lg z-10 backdrop-blur-sm">  <div className="sm:hidden flex justify-between items-center mb-[-10px]">
            ...
            <div className="p-2 rounded-full hover:bg-white/20 transition-all duration-300 cursor-pointer transform hover:scale-110">
              <Link
                ...
                className={` ${location.pathname === `/dashboard/assign-task`
                  ? "bg-white/20"
                  : ""
                  }`}
              >
                <PlusCircle size={29} className="drop-shadow-md" />
              </Link>
            </div>
            {/* <div className="p-3 rounded-full bg-white text-gray-600 hover:bg-gray-100 transition-all duration-300 cursor-pointer transform hover:scale-110 shadow-lg -mt-6">
              <Link
                to={"/dashboard/assign-task"}
